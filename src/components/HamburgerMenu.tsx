  ...
  return createPortal(
    <>
      ...
      <button
        ...
        className="fixed z-[9999] p-2 rounded-md hover:bg-white/10 transition-colors"
        style={{
          top: "16px",
          right: "16px",
          position: "fixed",
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <nav className="flex flex-col gap-2 p-8 pt-20 flex-grow">
            ...
            <a
              href="https://offroadchampion.com/contact/"
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => setIsOpen(false)}
              className="text-white hover:text-amber-400 text-lg font-semibold py-3 px-4 rounded-md hover:bg-white/5 transition-colors"
          ...
          {/* Social Media Links */}
          <div className="p-8 border-t border-amber-400/20">
            <div className="flex justify-center gap-6">
              <a
                href="https://www.facebook.com/pixelpiratestudio"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://twitter.com/pixelpiratetv"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white hover:text-amber-400 transition-colors"
                aria-label="Twitter"
              ...
              <a
                href="https://www.instagram.com/pixelpiratestudio/?hl=en"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white hover:text-amber-400 transition-colors"
              ...
              <a
                href="https://www.youtube.com/c/PixelPirateStudio"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white hover:text-amber-400 transition-colors"
                aria-label="YouTube"
